...
from generate_channel import generate_channel, channel_complex2real
from generate_received_pilots import generate_received_pilots_batch, channel_estimation_lmmse
from generate_received_pilots import compute_stat_info, generate_pilots_bl_v2, generate_pilots_bl
import os
...
def main_channel_estimation(params_system, len_pilot, noise_power_db, Pt, location_user, Rician_factor, path):
    ...
    print('Error_d: %0.3f' % err_bs_user, 'Error_r: %0.3f' % err_bs_irs_user, 'Error_sum: %0.3f'
          % (err_bs_user+err_bs_irs_user))
...
def main():
    ...
    for len_pilots in len_pilots_set:
        _, err_bs_user,err_bs_irs_user = main_channel_estimation(params_system, len_pilots, noise_power_db, Pt,
                                                                 location_user, Rician_factor, file_path)
    ...
    sio.savemat('lmmse_error.mat', {'err_bs_user_set':err_bs_user_set, 'err_bs_irs_user_set':err_bs_irs_user_set,
                                    'err_sum_set':err_sum_set})
